        ...
        <div className="flex flex-col min-h-full items-center p-4 md:p-8 w-full max-w-5xl mx-auto pb-24">
            ...
            <div className="w-full bg-brain-panel/50 backdrop-blur-xl rounded-2xl border border-white/5 shadow-2xl overflow-hidden mb-6 relative group">
                ...
                <canvas
                    ...
                    width={800}
                    height={200}
                    className="w-full h-48 object-cover opacity-90 transition-opacity duration-700"
                ></canvas>
            ...
            {/* Audio Source Panel (full width, compact) */}
            <div className="w-full bg-white/[0.03] backdrop-blur-md p-5 rounded-2xl border border-white/5 shadow-xl mb-6">
                <div className="flex flex-col md:flex-row gap-4 items-stretch">
                    {/* File Drop / Waveform */}
                    <div className="flex-1 min-w-0">
                        {audioBuffer ? (
                            <div className="relative w-full rounded-xl overflow-hidden shadow-2xl border border-white/5 bg-slate-900/50">
                            ...
                            <label className="group relative flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-slate-700/50 rounded-xl cursor-pointer hover:bg-white/[0.02] hover:border-brain-accent/30 transition-all duration-300">
                                <div className="flex items-center gap-3">
                                    <UploadCloud className="w-8 h-8 text-slate-500 group-hover:text-brain-accent transition-colors duration-300" />
            ...
            {/* Two-column grid: Liquid Dynamics (left) + Brainwave Entrainment (right) */}
